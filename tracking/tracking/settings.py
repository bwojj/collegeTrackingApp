...
SECRET_KEY = 'django-insecure-j8@)@s27h3pxo_gv3mc_wc&5ge+okw8za)805((oczmow6%ql9'
...
# Allow DATABASE_URL to override the local SQLite DB when present (e.g., on Render).
